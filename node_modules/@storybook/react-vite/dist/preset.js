import CJS_COMPAT_NODE_URL_9tlplyx5a4s from 'node:url';
import CJS_COMPAT_NODE_PATH_9tlplyx5a4s from 'node:path';
import CJS_COMPAT_NODE_MODULE_9tlplyx5a4s from "node:module";

var __filename = CJS_COMPAT_NODE_URL_9tlplyx5a4s.fileURLToPath(import.meta.url);
var __dirname = CJS_COMPAT_NODE_PATH_9tlplyx5a4s.dirname(__filename);
var require = CJS_COMPAT_NODE_MODULE_9tlplyx5a4s.createRequire(import.meta.url);
...
import {
  __name
} from "./_node-chunks/chunk-ACBQZUHT.js";
...
var viteFinal = /* @__PURE__ */ __name(async (config, { presets }) => {
  ...
  if (typeof reactDocgenOption === "string") {
    const { reactDocgen } = await import("./_node-chunks/react-docgen-HX6DVBX4.js");
    plugins.unshift(
